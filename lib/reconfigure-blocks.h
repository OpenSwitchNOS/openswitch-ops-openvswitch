 ...
 * references to related bridge configuration required by external plugins to
 * properly process the reconfigure events */
struct blk_params{
    const struct ovsrec_open_vswitch *ovs_cfg; /* Global bridge configuration */
    struct ovsdb_idl *idl; /* OVSDB IDL handler */
    struct bridge *br;  /* Reference to current bridge. Only valid for
                           reconfigure blocks parseing bridge instances */
