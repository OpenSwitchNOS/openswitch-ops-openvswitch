...
#define long_options_to_short_options(options) ovs_cmdl_long_options_to_short_options(options)
...
#define proctitle_init(argc, argv) ovs_cmdl_proctitle_init(argc, argv)
