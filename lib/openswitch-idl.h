...
/*
 * FIXME: Once the schema changes got merged (key was renamed
 * to v4relay_disabled)it will be removed.
 */
#define SYSTEM_OTHER_CONFIG_MAP_DHCP_RELAY_DISABLED    "dhcp_relay_disabled"

/* DHCP Configuration keys */
#define SYSTEM_DHCP_CONFIG_MAP_V4RELAY_DISABLED \
"v4relay_disabled"
...
#define SYSTEM_DHCP_CONFIG_MAP_BOOTP_GATEWAY \
"bootp_gateway"
