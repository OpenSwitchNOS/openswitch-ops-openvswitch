 ...
 *                         struct plugin_extension_interface *plugin_functions);
...
/**
    ...
    @param[in] plugin_interface The pointer to the plugin's interface structure.
                                The caller provides a struct pointer with the
