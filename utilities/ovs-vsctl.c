...
static struct cmd_show_table cmd_show_tables[] = {
    ...
    {&ovsrec_table_ospf_area,
     ...
     {
      &ovsrec_ospf_area_col_vlinks,
      &ovsrec_ospf_area_col_ospf_interfaces,
      &ovsrec_ospf_area_col_area_config},
     false},
    {&ovsrec_table_ospf_vlink,
     &ovsrec_ospf_vlink_col_area_id,
     {
      &ovsrec_ospf_vlink_col_auth_config,
      &ovsrec_ospf_vlink_col_vlink_config,
    ...
    {&ovsrec_table_ospf_interface,
     &ovsrec_ospf_interface_col_ifsm_state,
     {
      ...
      &ovsrec_ospf_interface_col_if_statistics},
     false},
    {&ovsrec_table_ospf_interface_config,
     &ovsrec_ospf_interface_config_col_auth_config,
     {
      &ovsrec_ospf_interface_config_col_nbma_nbr_config,
      &ovsrec_ospf_interface_config_col_passive_interface,
      &ovsrec_ospf_interface_config_col_ospf_if_config},
     false},
    {&ovsrec_table_ospf_lsa,
     &ovsrec_ospf_lsa_col_area_id,
     {
      ...
      &ovsrec_ospf_lsa_col_ls_age},
     false},
    {&ovsrec_table_ospf_neighbor,
     &ovsrec_ospf_neighbor_col_bdr,
     {
      &ovsrec_ospf_neighbor_col_dr,
      &ovsrec_ospf_neighbor_col_nbr_status,
      &ovsrec_ospf_neighbor_col_priority},
     false},
#endif
...
static const struct vsctl_table_class tables[] = {
    ...
    {&ovsrec_table_ospf_interface,
     ...
     {NULL, NULL, NULL}}},
    {&ovsrec_table_ospf_interface_config,
     {{&ovsrec_table_ospf_interface_config, &ovsrec_ospf_interface_config_col_auth_config, NULL},
     {NULL, NULL, NULL}}},
    {&ovsrec_table_ospf_lsa,
