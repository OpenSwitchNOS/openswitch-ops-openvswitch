...
This functionallity is going to be implemented using the skiplist. A skiplist is
...
returned pointer doesn't need to be saved anywere, except until all the index's
