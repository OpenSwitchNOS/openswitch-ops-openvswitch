 ...
 *                 const char plugin_name, struct ofproto_extension_interface *ptr);
 ...
 *                    unsigned int mayor, unsigned int minor, void **interface);
 *
...
/**
    ...
    @param[out] interface Returns the found interface, NULL if not found. You
                          can pass the direction of your struct pointer:
