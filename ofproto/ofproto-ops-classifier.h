...
/**
 * @defgroup ops-classifier-api OpenSwitch Classifier API
 * See ops-classifierd/DESIGN.md for additional information on this module.
 * @{
 *
 * @file
 */
...
{
    bool            stats_enabled;   /**< Are stats enabled on this list? */
...
typedef int (*ofproto_ops_cls_statistics_get)(
    ...
    struct ofproto                 *ofproto,
    void                           *aux,
    struct ops_cls_interface       interface_info,
    enum ops_cls_direction         direction,
 ...
 *                               used with ofproto to get
 *                               ofproto_bundle
 * @param[in]  interface_info  - interface information necessary for programming
 *                               hw (e.g. L3 only, port, vlan)
 * @param[in]  direction       - direction in which the list is applied
