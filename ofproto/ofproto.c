...
#include "lib/plugins/asic-plugin.h"
                          ...
                          char *next_hop_mac_addr, int *l3_egress_id)
{
    ...
    rc = find_asic_extension(
        asic_plugin_MAJOR,
        asic_plugin_MINOR,
        (void **) &intf);

    rc = (rc == 0 && intf)
      ? ((intf->add_l3_host_entry)
