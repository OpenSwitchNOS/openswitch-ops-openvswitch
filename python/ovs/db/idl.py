...
"""
    ...
    def __update_index_map(self, uuid, table, new):
    ...
    def __delete_from_index_map(self, row, table):
    ...
    def __process_update(self, table, uuid, old, new):
        ...
        if not new:
            # Delete row.
            if row:
                self.__delete_from_index_map(row, table)
                del table.rows[uuid]
                changed = True
        ...
        if _is_new_row:
            self.__update_index_map(uuid, table, new)
