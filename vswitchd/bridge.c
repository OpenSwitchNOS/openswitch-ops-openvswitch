...
static void
vrf_delete_or_reconfigure_subintf(struct smap *sub_intf_info, const struct ovsrec_interface *iface_cfg)
{
...
iface_refresh_netdev_status(struct iface *iface)
{
    ...
    else if (!iface->type || !strcmp(iface->type, OVSREC_INTERFACE_TYPE_VLANSUBINT)) {
