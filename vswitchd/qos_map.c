 ...
 *    under the License.
 *
 *    Contains switchd functions related to QOS COS and DSCP maps.
 *
 ***************************************************************************/
...
qos_get_color(const char *color_text)
{
    ...
    else if (!strcmp(OVSREC_QOS_COS_MAP_ENTRY_COLOR_GREEN, color_text)) {
        color = COS_COLOR_GREEN;
    }
    else if (!strcmp(OVSREC_QOS_COS_MAP_ENTRY_COLOR_YELLOW, color_text)) {
        color = COS_COLOR_YELLOW;
    }
    else if (!strcmp(OVSREC_QOS_COS_MAP_ENTRY_COLOR_RED, color_text)) {
        color = COS_COLOR_RED;
    }
    return color;
}
